...
fun KeyboardRoot() {
    ...
    val themeColor by repository.themeColorFlow
        .collectAsState(initial = ThemeColor.BLUE)

    val keyboardHeightScale by repository.keyboardHeightFlow
        .collectAsState(initial = 0.4f)
